...
def stocks(request):
    if request.method == 'POST':
        ...
        return render(request, 'stockanaysis/stocks.html', context)
...
def stock_detail(request, pk):
    ...
    return render(request, 'stockanaysis/stock-details.html', context)